...
if __name__ == "__main__":
    content = download_link("https://elpais.com/espana/2025-08-10/abascal-ataca-a-los-obispos-por-jumilla-no-se-si-su-posicion-es-por-los-ingresos-publicos-que-reciben-o-por-los-casos-de-pederastia.html")
    print(content)